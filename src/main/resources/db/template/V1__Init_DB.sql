...
create table user_role (user_id bigint not null, roles varchar(2048));
create table usr (id bigint not null, activation_code varchar(2048), active bit not null, email varchar(2048), password varchar(2048) not null, username varchar(2048) not null, primary key (id));
